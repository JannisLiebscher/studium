...
CMat4f getTransform(CVec4f viewOrigin, CVec4f viewDir, CVec4f viewUp) {
	...
	//Debug Prints
	//localViewDir.print("localViewDir");
	//localViewUp.print("localViewUp");
	//localViewLeft.print("localViewLeft");
...
/*CMat4f rotateCam(CVec4f axis, float angle) {
...
void keyboard(unsigned char key, int x, int y)
{
	...
	case '2':
		...
		break;
	case 'p':
		getTransform(eyePoint, viewDir, viewUp);
		break;
	case 'u':
		eyePoint(0)--;
		break;
