///////////////////////////////////////////////////////////////////////
//																	 //
// Codeger�st f�r Vorlesung Computergraphik WS 2023/24 �bung 1       //
//										                             //
///////////////////////////////////////////////////////////////////////
...
void translatePoint(Point plotPoint, Point center) {
	setPoint(Point(plotPoint.x + center.x, plotPoint.y + center.y));
}
//
// �BUNG 1 AUFGABE 2:
//
...
void bhamCircle (Point p, int r, Color c) {
	...
	y = r;
	d = 5 - 4 * r;
	translatePoint(Point(x, y),p);
	translatePoint(Point(x, -y),p);
	translatePoint(Point(y, x),p);
	translatePoint(Point(-y, x),p);
...
void display (void) 
{
	...
	Point p(20, 10);					// Mittelpunkt f�r Kreis definieren
